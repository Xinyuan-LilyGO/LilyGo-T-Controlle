...
{
    oled.clear();
    oled.drawString(DISPLAY_WIDTH / 2, DISPLAY_HEIGHT / 2, "battery test");
    oled.display();
    delay(1000);
}
...
{
    oled.clear();
    oled.drawString(DISPLAY_WIDTH / 2, DISPLAY_HEIGHT / 2, "wifi scan");
    oled.display();
    ...
    oled.clear();
    if (n == 0) {
        oled.drawString(DISPLAY_WIDTH / 2, DISPLAY_HEIGHT / 2, "no networks found");
        oled.display();
        return;
    }
    oled.drawString(DISPLAY_WIDTH / 2, DISPLAY_HEIGHT / 2, "Found" + String(n) + "net");
    oled.display();
}
...
{
    oled.clear();
    oled.drawString(DISPLAY_WIDTH / 2, DISPLAY_HEIGHT / 2, "enter sleep 10 sec");
    oled.display();
    delay(1000);
    oled.clear();
    oled.display();
...
void showVoltage()
{
    ...
    if (millis() - timeStamp > 1000) {
        ...
        oled.clear();
        oled.drawString(DISPLAY_WIDTH / 2, DISPLAY_HEIGHT / 2, voltage);
        oled.display();
#else
...
void setup()
{
    ...
    delay(50);
    oled.drawString(DISPLAY_WIDTH / 2, DISPLAY_HEIGHT / 2, "TTGO");
    oled.display();
#endif
...
void loop()
{
    ...
    case KEY1:
        oled.clear();
        oled.drawString(DISPLAY_WIDTH / 2, DISPLAY_HEIGHT / 2, "DOWN");
        oled.display();
        loop_mode = -1;
        break;
    case KEY2:
        oled.clear();
        oled.drawString(DISPLAY_WIDTH / 2, DISPLAY_HEIGHT / 2, "OK");
        oled.display();
        loop_mode = -1;
        break;
    default:
